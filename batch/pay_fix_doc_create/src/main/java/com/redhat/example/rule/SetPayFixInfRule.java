...
// Business Object
import com.redhat.example.entity.PayFixInfEntity;

@Component
public class SetPayFixInfRule {
    public PayFixInfEntity executeRule(Map<String, Object> exchange_message) {
        PayFixInfEntity entity = new PayFixInfEntity();
        ...
        entity.setCard_number(exchange_message.get("card_number").toString());
        entity.setCustomer_name(exchange_message.get("customer_name").toString());
        entity.setCustomer_address(exchange_message.get("customer_address").toString());
        entity.setSprv_limit_amount(Integer.valueOf(String.valueOf(exchange_message.get("sprv_limit_amount"))));
